...
if($_REQUEST['method'] == 'validate') {
    htMultiFilesUploadOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    htMultiFilesUploadOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    htMultiFilesUploadOutfittersLicense::add();
    ...
    $validate_license = htMultiFilesUploadOutfittersLicense::isValid($currentModule,$user_id,true);
