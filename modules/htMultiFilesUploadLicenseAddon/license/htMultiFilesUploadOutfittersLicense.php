...
if(!class_exists('htMultiFilesUploadOutfittersLicense')) {
    class htMultiFilesUploadOutfittersLicense {
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false) {
            ...
            $validated = htMultiFilesUploadOutfittersLicense::doValidate($thisModule);
        ...
        public static function validate() {
            ...
            $validated = htMultiFilesUploadOutfittersLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null) {
            ...
            {
                $GLOBALS['log']->fatal('htMultiFilesUploadOutfittersLicense::doValidate() failed: '.print_r($response,true));
            }
            return $response;
        ...
        public static function change() {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('htMultiFilesUploadOutfittersLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add() {
            ...
            $response = htMultiFilesUploadOutfittersLicense::doValidate($currentModule);
    ...
    class SugarOutfitters_API {
        private function get_default_payload($module,$custom_data = array()) {
            ...
            if (empty($custom_data['key'])){
                $key = htMultiFilesUploadOutfittersLicense::getKey($module);
